...
# Generated: Wed Dec 19 05:16:10 2018
##################################################
...
class wifi_transceiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.pluto_source_0 = iio.pluto_source('', 3500000000, 10000000, 20000000, 0x8000, True, True, True, "manual", 64.0, '', True)
        self.pluto_sink_0 = iio.pluto_sink('', 3500000000, 10000000, 20000000, 0x8000, False, 10.0, '', True)
