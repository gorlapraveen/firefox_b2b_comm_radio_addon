...
class pluto_msg_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Pluto Msg Tx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Pluto Msg Tx")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "pluto_msg_tx")
        ...
        # Blocks
        ##################################################
        self._tx_gain_range = Range(0, 20, 0.01, 10, 200)
        ...
        self.pluto_sink_0 = iio.pluto_sink('', freq, 10000000, 20000000, 0x8000, False, tx_gain, '', True)
        self._pdu_length_range = Range(0, 1500, 1, 1500, 200)
        ...
        self.ieee802_11_mac_0 = ieee802_11.mac(([0x32, 0x32, 0x32, 0x32, 0x32, 0x32]), ([0x29, 0x29, 0x29, 0x29, 0x29, 0x29]), ([0xff, 0xff, 0xff, 0xff, 0xff, 255]))
...
###Set Text Message Below.
    ...
    def set_tx_gain(self, tx_gain):
        ...
        self.pluto_sink_0.set_params(self.freq, 10000000, 20000000, self.tx_gain, '', True)
...
def main(top_block_cls=pluto_msg_tx, options=None):
